...
portfolio reaching a target value over a multi-year horizon, and quantifies the
full range of possible outcomes. Built in Python with formatted Excel output.
...
| P10 (pessimistic) | $101,000 |
| P50 (median) | $176,000 |
| P90 (optimistic) | $317,000 |

### Probability cone
![Probability cone](probability_cone.png)
...
- **Lognormal return model** — growth factors are always positive, so portfolio
  ...
  correctly (standard model for asset prices).
...
## Outputs
- Jupyter notebook with the full simulation workflow
- Probability cone and terminal-distribution charts
- Formatted Excel workbook (assumptions, results, year-by-year cone data, and
  embedded charts)
- Methodology note documenting the simulation design

## Tech
Python, NumPy, Matplotlib, openpyxl.
